...
if (isset($_POST['username']) && isset($_POST['student_id']) && isset($_POST['password']) && isset($_POST['confirm_password'])) {
    ...
    $sql = "INSERT INTO students (username, student_id, password) VALUES (?, ?, ?)";

    // Prepare a statement object for secure insertion
    $stmt = $conn->prepare($sql);

    // Bind the parameters to the statement
    $stmt->bind_param("sss", $username, $student_id, $hashed_password); // Use hashed password
